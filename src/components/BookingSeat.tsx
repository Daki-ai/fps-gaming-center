      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        <div className="animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8 flex-wrap">
            <Button variant="hero" size="lg" className="text-lg px-8 py-6 font-bold w-full sm:w-auto" asChild>
              <a href={`https://wa.me/38976445566?text=${whatsappMessage}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3">
            ...
            <Button variant="hero" size="lg" className="text-lg px-8 py-6 font-bold w-full sm:w-auto" asChild>
              <a href={`viber://chat?number=%2B38976445566&text=${viberMessage}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3">
                <MessageCircle className="w-6 h-6" />
                Viber
              </a>
            </Button>
            ...
            <Button variant="hero" size="lg" className="text-lg px-8 py-6 font-bold w-full sm:w-auto" asChild>
              <a href="https://www.instagram.com/fps_gaming_center/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3">
          ...
          <a href="tel:076445566" className="inline-flex items-center gap-3 text-2xl font-bold text-gold hover:text-gold-glow transition-colors mb-12">
